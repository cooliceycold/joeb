<style>
body {
    cursor:url('https://pic.imgdb.cn/item/65f172079f345e8d0314a6fa.png'), auto !important;
}
select, input, textarea, a, button {
    cursor:url('https://pic.imgdb.cn/item/65f172079f345e8d0314a796.png'), auto !important;
}
...
<script>
	...
	?>
	console.log("%c狗子のTypecho", "color:#fff; background: linear-gradient(270deg, #986fee, #8695e6, #68b7dd, #18d7d3); padding: 8px 15px; border-radius: 0 15px 0 15px");
...
<!-- 樱花 -->  
<script src="https://fastly.jsdelivr.net/gh/lizina66/api/img/jpuer.js"></script>
